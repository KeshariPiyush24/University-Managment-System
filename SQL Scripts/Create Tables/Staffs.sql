...
insert into STAFFS values(325475,'Electrician');
insert into STAFFS values(451326,'Carpenter');
insert into STAFFS values(565767,'Plumber');
insert into STAFFS values(625648,'Plumber');
